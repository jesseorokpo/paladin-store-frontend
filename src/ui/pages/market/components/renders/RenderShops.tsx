import { Avatar, Box, Center, Divider, Grid, Group, Paper, Stack, Text } from "@mantine/core";
                ...
                {brands.map(element => {
                    return <Grid.Col  xs={6} sm={6} md={3}>
                        <Paper withBorder sx={{ overflow: "hidden" }}>
                            ...
                            <Box>
                                <Box sx={{
                                    paddingTop: "70%", backgroundColor: "#FEF7E7",
                                    position: 'relative'
                                }}>
                                    ...
                                    <Center p={"8px"} sx={{ borderRadius: 50, position: "absolute", bottom: -13, right: 12, background: "#00B2F0" }}>
                            ...
                            <Stack spacing={"xs"} sx={{ flex: 1, }} px="12px" py="12px">
                                <Box>
                                    <Text sx={{ fontWeight: "bold", color: "#183B56" }}>Bolade Beauty Shop</Text>
                                    <Text sx={{ color: "#183B56" }}>Oshodi Market, Lagos</Text>
                                </Box>
                                <Divider color={"ghostwhite"} />
                                <Text size={"sm"} sx={{ color: "#183B56" }}>The best beauty product shop with cheap price</Text>
                            </Stack>
